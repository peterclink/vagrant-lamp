...
sudo apt-get -y --force-yes php5.6-common php5.6-cli php5.6 libapache2-mod-php5.6 php-pear php5.6-mysql php-xdebug php5.6-curl php5.6-mbstring php5.6-mcrypt
